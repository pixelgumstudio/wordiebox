          ...
          <div className="flex w-fit gap-2 items-center mx-auto mb-6">
            ...
            <div className="relative inline-block w-[72px] shadow-darkbox">
              <select
                ...
                className="block appearance-none w-full bg-white border text-[#1C1C1C] border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 shadow leading-tight focus:outline-none focus:shadow-outline"
              >
                {options.map((option) => (

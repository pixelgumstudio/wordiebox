...
function WordCount() {
  ...
  const metadata = {
    title: `Free online ${pageName} word counter - Wordiebox.com`,
    description: `${pageName} Word Counter tool is a free online tool that calculates the number of words in your writing.`,
    openGraph: {
      title: `Free online ${pageName} word counter tool | Wordiebox`,
      description: `${pageName} Word Counter tool is a free online tool that calculates the number of words in your writing.`,
      url: `https://wordiebox.com/word-counter/${pageName}`,

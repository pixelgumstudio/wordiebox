...
function WordCount() {
  ...
  return (
    ...
    <textarea name="message" rows={10} cols={50} placeholder='Start writing or paste text' value={text} onChange={count}className={`px-5 py-5  mt-2 outline-none h-fit w-full bg-transparent border-[#1C1C1C] border shadow-darkbox`}  />

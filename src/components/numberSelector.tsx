        ...
        return (
                  ...
                  <div className="relative inline-block w-[72px] shadow-darkbox">
                    <select
                      ...
                      className="block appearance-none dark:text-black w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 shadow leading-tight focus:outline-none focus:shadow-outline"
                    >
                      {options.map((option) => (

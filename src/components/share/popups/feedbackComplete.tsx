...
export default function FeedBackCongrats({visible, updateView}: {visible:boolean, updateView:any}) {
    ...
    visible && (
      <div className="w-[100vw] h-[100vh] flex items-center justify-center bg-overlay fixed top-0 left-0 z-20">
        <div className="p-6 bg-[#F8F7F1] border text-center border-[#1C1C1C] w-full max-w-[398px]">
          ...
          <p className="text-20 capitalize">Your feedback has been received successfully, we will reach out if we require further information from you!</p>
          <button
            onClick={()=>updateView({status:false})}

...
const Cards = () => {
  return (
    <div className='w-full bg-[#FBF4EE] '>
      ...
      <div className='flex flex-col gap-5 tablet:gap-[40px] items-center laptop:flex-row laptop:flex-wrap laptop:justify-between laptop:items-stretch laptop:gap-0 text-center'>
      ...
      <Card color="#FFC4DF" image={Character_Counter} title='Character Counter' description='Need help counting the characters in your writing project? check this out.' link='character-counter' />
      <Card color="#C2FFD9" image={Word_Counter} title='Word Counter' description='Have trouble tracking your word count? check this out.' link='word-counter' />
      <Tap />
      </div>
    </div>
